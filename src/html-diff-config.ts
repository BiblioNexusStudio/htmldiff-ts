export class HtmlDiffConfig {
    ...
    public setInsertSpaceInReplace(insertSpaceInReplace: boolean): HtmlDiffConfig {
    ...
    public setIsolatedDiffTags(isolatedDiffTags: { [key: string]: string }): HtmlDiffConfig {
        this.isolatedDiffTags = isolatedDiffTags;
        return this;
    }

    public addIsolatedDiffTag(tag: string, placeholder: string | null = null): HtmlDiffConfig {
        if (placeholder === null) {
